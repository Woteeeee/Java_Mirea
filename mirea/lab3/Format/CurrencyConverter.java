...
public class CurrencyConverter {
    ...
    public CurrencyConverter(String value1, String value2, double amount){
        this.value1 = value1;
        this.value2 = value2;
        this.amount = amount;
    }
    ...
    public static String converted_to_locale(double amount, String curr){
        ...
        if ((curr.matches("RU")) || (curr.matches("RUB")))
            return ru.format(amount);
        else if ((curr.matches("US")) || (curr.matches("USD")))
    ...
    public static void main(String[] args){
        ...
        CurrencyConverter conv = new CurrencyConverter(value1, value2, amount);

        String result = converted_to_locale(conv.convert(), value2);

        String value1_currency = value1.substring(value1.length()-3,value1.length()-1);
        String value1_form = converted_to_locale(amount, value1_currency);
